...
public class StringUtil {
    ...
    /**
     * 密码格式校验，正则表达式匹配。长度为6-20 位，只能包含字母、数字以及标点符号（除空格）
     * 字母、数字和标点符号至少包含2种
     * @auther chenguihao
     */
    public static final boolean checkPasswordFormat(String password) {
        String regStr = "(?!^\\d+$)(?!^[A-Za-z]+$)(?!^[^A-Za-z0-9]+$)(?!^.*[\\u4E00-\\u9FA5].*$)^\\S{6,20}$";
