...
public class EmailConsumer {
    ...
    public void handleEmailQueue(String email) {
        String content0 = "请点击下面的按钮完成注册：<br>\n" +
                ...
                "<a target=\"_blank\" href=\"192.168.100.117:8888/shopManage/activateEmail?registryId=";
        String content1 = "\" style=\"width:104px; height:40px; float:left; background-color:#FFFCCD;\">\n" +
                ...
                "<a target=\"_blank\" href=\"192.168.100.117:8888/shopManage/activateEmail?registryId=";
        String content2 = " style=\"color:#0040D8; text-decoration:none\">192.168.100.117:8888/shopManage/activateEmail?registryId=";
        String content3 = "\" </a>\n </div> <div class=\"link-text\" style=\"padding:10px 0px 15px; color:#41648D\"> 也可以复制下面的链到浏览器地址栏中完成注册：<br> <span style=\"color:#000\">192.168.100.117:8888/shopManage/activateEmail?registryId=</span> </div>";
        ...
        try {
            ...
            sb.append(content0).append(md5).append(content1).append(md5).append(content2).append(md5).append(content3).append(md5);
